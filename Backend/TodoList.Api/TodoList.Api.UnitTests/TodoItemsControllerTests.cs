...
namespace TodoList.Api.UnitTests
{
    public class TodoItemsControllerTests : IDisposable
    {
        ...
        public TodoItemsControllerTests()
        {
            ...
            _controller = new TodoItemsController(_mockLogger.Object, _todoItemService);

            _context.TodoItems.AddRange(new List<TodoItem>
            {
                new TodoItem { Id = Guid.NewGuid(), Description = "An item description", IsCompleted = false },
                new TodoItem { Id = Guid.NewGuid(), Description = "Another descrition", IsCompleted = false }
            });
